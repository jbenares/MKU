...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php	if($b == "Generate Report"){ ?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="tire/print_eq_tires_2.php?from_date=<?=$from_date?>&categ_id2=<?=$_REQUEST['categ_id2']?>&eqID=<?=$_REQUEST['eqID']?>" width="100%" height="500">
        </iframe>
    <?php } ?>
    </div>
</div>
