...
<div class="container">
     ...
     <div><!--Start of Form-->
     	...
     	<div style="font-weight:bolder;">
            ...
            BRANDING #: <?=$branding_num?> <br />
            From <?=date("m/d/Y",strtotime($from_date))?> to <?=date("m/d/Y",strtotime($to_date))?>
        </div>
        <br/>
        <div class="content">
        	<table cellpadding="3" border=1 style="width:1200px;">
            	 <tr>
             	...
             	<?php
					$query="SELECT * FROM tiretransfer WHERE branding_num = '$branding_num' AND date BETWEEN '$from_date'
