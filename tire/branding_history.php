...
<div class=form_layout>
    ...
    <div class="module_actions">           
        <table class="table-form">
            ...
            <tr>
            	<td>Branding #:</td>
                <td>
                	<input type="text" class="textbox3" name="branding_num" value="<?=$branding_num?>">
                </td>
            </tr>
      	</table>
  	</div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php	if($b == "Generate Report"){ ?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="tire/print_branding_history.php?from_date=<?=$from_date?>&to_date=<?=$to_date?>&branding_num=<?=$branding_num?>" width="100%" height="500">
        </iframe>
    <?php } ?>
    </div>
</div>
