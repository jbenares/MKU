        ...
        <div class="content" >
        	<table cellspacing="0" class="withborder">
            	<tr>
					...
					<th style="border-top:1px solid #000; border-bottom:1px solid #000; text-align:left;">Receive</th>
					<th style="border-top:1px solid #000; border-bottom:1px solid #000; text-align:left;">Days</th>
               ...
               // echo $query;
				...
				if($m_class == '1' || $m_class == '3' || $m_class == '4' || $m_class == '5' || $m_class == '6' || $m_class == '7' || $m_class == '9' || $m_class == '11'){
                ...
                ?>
                <tr>
                	<td colspan="8" style="border-top:1px solid #000; border-bottom:1px solid #000;">Balance Forwarded</td>
                ...
                while($details_row=mysql_fetch_assoc($details_result)):
					...
					$date_received = $options->getAttribute("sales_invoice","sales_invoice_id",$details_row['header_id'],"date_received");
					$date = $details_row['date'];
					$interval = date_diff (date_create($date_received),date_create($date));
                ...
                ?>
                    <tr>
						...
						echo "
							<td>".$options->getGLAccountName($details_row['account_id'])."<br />".getMRRItems($details_row['header_id'])."</td>
				...
				?>       
                <tr>
                    <td colspan="8" style="border-top:1px solid #000;"><div align="right">Total</div></td>
					...
					<?php }else{ ?>
					<td style="border-top:1px solid #000; text-align:right;"><span style="text-align:right; font-weight:bold; border-bottom:3px double #000;"><?=number_format((($t_credit+$bcredit))-($t_debit+$bdebit),2,'.',',')?></span></td>
					<?php } ?>
                </tr>  
            </table>
