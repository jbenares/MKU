     ...
     <div><!--Start of Form-->
        ...
        <div class="content" style="">
        	<table style="width:100%;">
				...
				$balance+=$options->getBalanceForwarded($startdate,$account_id);
				?>
                <tr>
                    <td colspan="5"><div align="left">Balance Forwarded</div></td>
                    <td><div align="right"><?=number_format($options->getBalanceForwarded($startdate,$account_id),2,'.',',');?></div></td>
                </tr>
