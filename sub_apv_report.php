...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     ...
     if(!empty($_REQUEST['from_date']) && !empty($_REQUEST['to_date']))
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="transactions/print_sub_apv_report.php?from_date=<?=$_REQUEST['from_date'];?>&to_date=<?=$_REQUEST['to_date']?>&payment_status=<?=$payment_status?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>	
