...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
     if(!empty($_REQUEST['from']) && !empty($_REQUEST['to']) && !empty($_REQUEST['account_id']))
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="print_supplier_adjustments.php?from=<?=$_REQUEST['from'];?>&to=<?=$_REQUEST['to']?>&account_id=<?=$_REQUEST['account_id']?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
