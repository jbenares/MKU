...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     ...
     if(!empty($_REQUEST['from']) && !empty($_REQUEST['to']) && !empty($_REQUEST['gchart_id']))
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="print_beginning_balance_breakdown.php?from=<?=$_REQUEST['from']?>&to=<?=$_REQUEST['to']?>&gchart_id=<?=$_REQUEST['gchart_id']?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
