...
define('TITLE', "JOB ORDER HISTORY PER EQUIPMENT CATEGORY");
...
$eq_cat_name = ( $eq_catID ) ? lib::getAttribute('equipment_categories','eq_catID',$eq_catID,'eq_cat_name') : "";

function getReport($from_date,$to_date = NULL , $eq_catID,$eqID){
	...
	$sql="
		...
		$sql_date
	";
	if( $eq_catID ) $sql .= "and eq_catID = '$eq_catID'";
        if( $eqID ) $sql .= "and h.equipment_id = '$eqID'";
     ...
     <div><!--Start of Form-->
        ...
        <div class="content" >
        	<table cellspacing="0">
                ...
                <tbody>                  
                    <?php                               
                    $aReport= getReport($from_date,$to_date,$eq_catID,$eqID);
