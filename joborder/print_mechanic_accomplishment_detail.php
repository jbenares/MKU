...
define('TITLE', "MECHANIC ACCOMPLISHMENT DETAIL");

$conducted_by = $_REQUEST['conducted_by'];
$from_date    = $_REQUEST['from_date'];
$to_date      = $_REQUEST['to_date'];

function getReport($from_date,$to_date = NULL , $conducted_by){
	...
	if( $conducted_by ) $sql .= "and conducted_by = '$conducted_by'";
     ...
     <div><!--Start of Form-->
        ...
        <div class="content" >
        	<table cellspacing="0">
                ...
                <tbody>                  
                    <?php                               
                    $aReport= getReport($from_date,$to_date,$conducted_by);
