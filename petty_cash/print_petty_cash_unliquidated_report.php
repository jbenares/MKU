...
<body>
    	...
    	<thead>
        	<tr>
            	<td colspan="7">
                	<div>
                    	<?=$title?><br />
                        PETTY CASH NOT-LIQUIDATED REPORT<br />
	...
	<tr>		
		...
		Prepared By :<p>______________________<br /><b>Jonah Roque</b></p>
		   ...
		   <td width="80px">&nbsp;</td>
		  <td>
		Checked By :<p>______________________<br /><b>Rommel Armenion</b></p>
	       </td>
		   <td width="80px">&nbsp;</td>
		   <td>
		...
		<td width="80px">&nbsp;</td>
		   <td>
		Approved By :<p>______________________<br /><b>Jose Eduardo Cruz</b></p>
	       </td>
	</tr>
</table>
</body>
