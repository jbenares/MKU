...
<div class=form_layout>
	<div class="module_title"><img src='images/user_orange.png'>Generate Report - RJR Petty Cash</div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php  if(!empty($from_date) && !empty($to_date) ) { ?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="petty_cash/print_petty_cash_report_rjr.php?
            from_date=<?=$from_date?>&
            to_date=<?=$to_date?>
