...
<?php
/*23 before*/
$details = "<div style='margin-top:-163px;'></div>";
$details .= "<br /><br /><br /><br /><br /><br /><br /><br />CV#".$aVal['cv_no']. "\n";
$details .= 	space(104)."<b>".date("F, j Y",strtotime($det['check_date']))."</b><br /><br />";

$details .= "<div style='margin-bottom:-1px;'></div>";
$details .=
		space(28).adjustSize(substr($options->getAttribute('supplier','account_id',$aVal['supplier_id'],'account'),0,43),43).
		space(23)."<bold>***".number_format($check_amount,2)."***</bold>\n\n".
