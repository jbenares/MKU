...
<div class=form_layout>
    ...
    <?php
	if(!empty($fromdate) && !empty($todate) && !empty($account_id))
	{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="print_report_summaryOfReturns.php?fromdate=<?=$fromdate?>&todate=<?=$todate?>&account_id=<?=$account_id?>" width="100%" height="500">
        </iframe>
    </div>
    <?php
    }
