		...
		<tr>
			...
			<br />
				...
				<tr>
					...
					<td width="15%" style="text-align: right; padding-right: 20px;"></td>
					<td width="25%" style="text-align: right; padding-right: 20px;"></td>
				</tr>
				<?php
				...
				<tr>
					<td colspan="5">
						...
						<tr>
							<td width="5%" ></td>
							<td width="20%" style="text-align: right; padding: 7px 25px 7px 7px;"></td>
						</tr>
						<tr>
							<td width="5%" ></td>
							<td width="20%" style="text-align: right; padding: 7px 25px 7px 7px"></td>
