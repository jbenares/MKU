...
<div class=form_layout>
    ...
    <table id="my_table" cellspacing="2" cellpadding="5" width="100%" align="center" class="search_table">
		...
		?>
            ...
            <td width="15"><a href="admin.php?view=5d8be66488f215b6ffb3&pr_header_id=<?=$pr_header_id?>" title="No Budget"><img src="images/edit.gif" border="0"></a></td>
