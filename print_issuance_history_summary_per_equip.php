...
function getEquipments(){
	$result = mysql_query("
		select * from equipment order by eq_name asc
	") or die(mysql_error());	
...
<div class="container">
     ...
     <div><!--Start of Form-->
        ...
        <div class="content" style="">
        	<?php foreach(getEquipments() as $eq){ ?>
            <?php
			$query="
				select
					*
			...
			if($_REQUEST[project_id]){
				$query.="
				and
					h.project_id = '$_REQUEST[project_id]'
			";	
			}
            ...
            ?>
        	<table cellpadding="3">
            	<caption style="text-align:left; font-weight:bold;"><?=$eq['eq_name']?></caption>
            	<tr>
