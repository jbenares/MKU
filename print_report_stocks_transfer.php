...
<div class="container">
    ...
    <div style="text-align:right; font-weight:bolder;">
        Transfer #. : <?=str_pad($transfer_header_id,7,0,STR_PAD_LEFT)?><br />
    </div>       
    ...
    <div class="header" style="">
        <table style="width:100%;">
            <tr>
                <td width="22%">To Project / Section:</td>
                <td width="49%" style="border-bottom:1px solid #000;"><?=$project_name?></td>
                
                <td width="7%">Date:</td>
                <td width="22%" style="border-bottom:1px solid #000;"><?=date("F j, Y",strtotime($date))?></td>
            </tr>
            <tr>
              <td>Scope of Work:</td>
