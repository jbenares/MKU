...
<div class="container">
    ...
    <table cellspacing="0" class="issuance_table" style="margin-top:10px;">
        <tr>
            <th style="text-align:left; width:5%;">Reference</th>
            <th style="text-align:right; width:5%;">Qty</th>
            <th style="text-align:left; width:5%;">Unit</th>
            
            <th style="text-align:right; width:5%;">Kg/Pc</th>
        ...
        for( ; $c < count($ris) ; $c++ ){
			...
			$account = ($account_id) ? "( ".$options->getAttribute('account','account_id',$account_id,'account')." )" : "";
			
			$eq = ($equipment_id) ? "( ".$options->getAttribute('equipment','eqID',$equipment_id,'eq_name')." )" : "";
    ...
    <?php  break; }  ?>
    <table class="issuance_table" style="width:100%;">
	    <tr>
            <td style="border:1px solid #000;"><div align="right">Total Kg</div></td>
            <td style="text-align:right; font-weight:bolder; width:10%;" >P <?=number_format($t_kg,2,'.',',')?></td>
        </tr>
        <tr>
            <td style="border:1px solid #000;"><div align="right">Total Quantity</div></td>
            <td style="text-align:right; font-weight:bolder; width:10%;" >P <?=number_format($total_qty,2,'.',',')?></td>
        </tr>
        
        <tr>
            <td style="border:1px solid #000;"><div align="right">Total</div></td>
