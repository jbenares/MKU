	...
	if($b=='Delete Selected') {
	  if(!empty($checkList)) {
		foreach($checkList as $ch) {	
			mysql_query("delete from brand where brand_id='$ch'");
		}
	  }
	}
?>
...
<div class=form_layout>
    ...
    <div class="module_actions">
        ...
        <input type="submit" name="b" value="Search Brand" class="buttons" />
    ...
    <table cellspacing="2" cellpadding="5" width="100%" align="center" class="search_table">
		...
		<?php								
			while($r=mysql_fetch_assoc($rs)) {
				...
				echo '<td><input type="checkbox" name="checkList[]" value="'.$r[brand_id].'" onclick="document._form.checkAll.checked=false"></td>';
				echo '<td width="15"><a href="#" onclick="xajax_edit_brandform(\''.$r[brand_id].'\');" title="Edit Entry"><img src="images/edit.gif" border="0"></a></td>';
				echo '<td>'.$r[brandcode].'</td>';	
				echo '<td>'.$r[brandname].'</td>';	
				echo '</tr>';
			}
        ?>
        <tr>
