...
<div class=form_layout>
    ...
    <div class="module_actions">       
        ...
        <div style="display:inline-block;">
            ...
            <input type="text" class="textbox3 datepicker" name="todate" value='<?php echo ($todate)?$todate:date("Y-m-d") ;?>' readonly='readonly' >
   	   	...
   	   	<div class='inline'>
            Account : <br />        
            <input type="text" class="textbox" id="account_name" value="<?=$account_name?>"  onmouseover="Tip('Leave empty to search all accounts');"/>
            <input type="hidden" name="account_id"  id="account_id" value="<?=$account_id?>" />
        </div>   
        
        <div class="inline">
	        Display Items with Discrepancy :  <br />
	...
	{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="print_report_orderDeliverySummary.php?fromdate=<?=$fromdate?>&todate=<?=$todate?>&account_id=<?=$account_id?>&option=<?=$option?>" width="100%" height="500">
        </iframe>
    </div>
    <?php
    }
