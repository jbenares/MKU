...
<div class=form_layout>
    ...
    <div class="module_actions">
        ...
        <input type="submit" name="b" value="Search Accounts" class="buttons" />
      <!--  <input type="submit" name="b" value="Display All" class="buttons" />-->
        <input type="button" name="b" value="Add Account" onclick="xajax_new_accountform();toggleBox('demodiv',1);" class="buttons" />
