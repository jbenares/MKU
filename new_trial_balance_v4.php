...
<div class=form_layout>
	...
	<?php if($_REQUEST['b'] == "Generate Report"){ ?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="new_print_trial_balance_v4.php?from=<?=$_REQUEST['from']?>&to=<?=$_REQUEST['to']?>" width="100%" height="500">
        </iframe>
	<?php} ?>
    </div>
</div>
