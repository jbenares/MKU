...
<div class=form_layout>
    ...
    <div class="module_actions">       
        ...
        <div class="inline">
            Stock<br />
            <?=$options->getAllMaterialOptions($_REQUEST[stock_id]);?>
        </div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="ar_print_monthly_sales_report_by_product.php?year=<?=$_REQUEST['year'];?>&amp;locale_id=<?=$_REQUEST[locale_id]?>&amp;stock_id=<?=$_REQUEST[stock_id]?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
