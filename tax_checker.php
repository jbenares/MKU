...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
     if(!empty($_REQUEST['from']) && !empty($_REQUEST['to']) && !empty($_REQUEST['percent']))
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="print_tax_checker.php?from=<?=$_REQUEST['from']?>&to=<?=$_REQUEST['to']?>&percent=<?=$_REQUEST['percent']?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
