...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="printSalesByCustomer.php?fromdate=<?=$_REQUEST['fromdate'];?>&todate=<?=$_REQUEST['todate'];?>&locale_id=<?=$_REQUEST[locale_id]?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
