...
<div class=form_layout>
	...
	{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="print_report_deliverySummary.php?fromdate=<?=$fromdate?>&todate=<?=$todate?>&account_id=<?=$account_id?>" width="100%" height="500">
        </iframe>
    </div>
    <?php
    }
