...
<?php
	...
	if($from_cv_no && $to_cv_no){
		$query = "select * from cv_header where status != 'C' and cv_no between '$from_cv_no' and '$to_cv_no'";
	}else{
		$query = "select * from cv_header where status != 'C' and cv_date between '$from_date' and '$to_date'";
	}
