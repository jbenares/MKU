...
$to_project_name	= $_REQUEST['to_project_name'];
...
<div class=form_layout>
    ...
    <div class="module_actions">    
    	...
    	<table class="table-form">
			...
			<tr>
            	<td>To Project :</td>
                <td>
                	<input type="text" class="textbox project" name="to_project_name" value="<?=$to_project_name?>" onclick="this.select();"  />
		            <input type="hidden" name="to_project_id" value="<?=($_REQUEST['to_project_name']) ? $_REQUEST['to_project_id'] : ""?>"  />
                </td>
            </tr>	
        </table>
    	<table class="table-form">
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php	if($b=="Generate Report"){ ?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="transactions/print_ts_log_history.php?
        	from_date=<?=$from_date?>&
            to_date=<?=$to_date?>&
