...
<?php
/*23 before*/
$details = "<div style='margin-top:-138px;'></div>";
$details .= "<br /><br /><br /><br /><r /><br /><br /><br />CV#".$aVal['cv_no']. "\n";
$details .= 	space(108)."<b>".date("F, j Y",strtotime($det['check_date']))."</b><br /><br /><br />";

$account = adjustSize(substr($options->getAttribute('supplier','account_id',$aVal['supplier_id'],'account'),0,47),50);
...
$details .=
		...
		$space."<bold>".number_format($check_amount,2)."</bold>\n\n".
                space(18)."<b >***".strtoupper($words).'ONLY***</b>'."\n".
