...
<div class=form_layout>
	...
	//			$rPC = mysql_fetch_array($getPayCenter);
				...
				//if($_SESSION['access_id']==16 || $_SESSION['access_id']==1 || $_SESSION['access_id']==2|| $_SESSION['access_id']==33){
				...
				//if($_SESSION['access_id']==16 || $_SESSION['access_id']==1 || $_SESSION['access_id']==2){
					echo '<td width="15"><a style="cursor:pointer;" onclick="xajax_violations(\''.$r[employeeID].'\',\''.$employeeName.'\');" title="Add Violations"><img src="images/book_open.png" border="0"></a></td>';
				//}else{
				//	echo '<td width="15">&nbsp;</td>';
				//}
