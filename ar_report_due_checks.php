...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="ar_print_report_due_checks.php?startdate=<?=$_REQUEST[startdate];?>&amp;enddate=<?=$_REQUEST[enddate]?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
