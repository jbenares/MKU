...
<div class=form_layout>
    ...
    <div class="module_actions">       
        ...
        <div class="inline">
            Month<br />
            <?=$options->getMonthOptions($_REQUEST[month]);?>
        </div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="printBalanceSheet2.php?month=<?=$_REQUEST['month'];?>&year=<?=$_REQUEST['year'];?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
