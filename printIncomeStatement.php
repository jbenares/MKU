        ...
        <div class="content" >
        	<table cellspacing="0" class="withborder">
                ...
                while($gchart_row=mysql_fetch_assoc($gchart_result)):
					...
					$yeartodate=$options->solveForYearToDate($gchart_row['gchart_id'],$endingdate,FALSE);
					$lastyear=$options->solveForLastYear($gchart_row['gchart_id'],$endingdate,FALSE);
					$debit=$a[debit];
					$credit=$a[credit];
					...
					if($debit || $credit || $lastyear || $yeartodate):
				?>	
				<tr>
                ...
                <tr>
                    ...
                    <td class="alignRight"><?=number_format($totalrevenue,2,'.',',')?></td>
                    <td>TOTAL REVENUE</td>
                    <td></td>
                ...
                <tr>
                	<td class="alignRight"></td>
                    <td class="alignRight"><?=number_format($totalexpense,2,'.',',')?></td>
                ...
                <tr>
                	<td class="alignRight"></td>
                    <td class="alignRight"><?=number_format($totalcredit-$totaldebit,2,'.',',')?></td>
