...
<div class="container">    
    ...
    <div style="position:absolute; top:6.6cm; left:4.3cm; line-height:20px;">
   ...
   <div style="position:absolute; top:6.80cm; left:4.2cm; line-height:20px;">
    	CV#<?=str_pad($cv_no,5,0,STR_PAD_LEFT)?><br />
        <br />
        <br />
    ...
    <div style="position:absolute; top:9.80cm; left:4.2cm; line-height:20px;">
             <div style="font-size:11px; margin-left:20px;"><?=$particulars?></div>
    </div>
    ...
    <div style="position:absolute; top:20.3cm; left:3.7cm; width:90%; line-height:20px;font-weight:bold; font-size:10px;" >
    	<?=$supplier?> <br /><br />
        <?=$words?> ONLY<br />
        CV#<?=str_pad($cv_no,5,0,STR_PAD_LEFT)?>
    </div>
    
    <div style="position:absolute; top:19.7cm; right:1.35cm; line-height:25px;font-weight:bold; font-size:10px;">
    	<span style="position:absolute;right:2cm;"><?=$check_date?></span>
    	<br />
    	<b style="font-size:16px;"><?=number_format($_cash_amount,2,'.',',')?></b>
    </div>
