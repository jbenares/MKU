...
<div class=form_layout>
    ...
    <div class="module_actions">       
        ...
        <div style="display:inline-block;">
            <?php
			echo lib::getTableAssoc($_REQUEST[stock_id],'stock_id',"Select Equipment","select * from productmaster where categ_id1=25 ORDER by stock ASC",'stock_id','stock');
			?>
        </div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php  if(!empty($from_date) && !empty($to_date) ) { ?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="vehicle_pass/print_vehicle_pass_report.php?
            from_date=<?=$from_date?>&
            to_date=<?=$to_date?>&
			stock_id=<?=$stock_id?>
