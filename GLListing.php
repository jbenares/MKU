...
<div class=form_layout>
    ...
    <div class="module_actions">       
    	...
    	<div class="inline">
            Journal<br />
            <?=$options->getGChartOptions($_REQUEST[gchart_id]);?>
        </div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="printGLListing.php?startingdate=<?=$_REQUEST['startingdate'];?>&endingdate=<?=$_REQUEST['endingdate'];?>&gchart_id=<?=$_REQUEST['gchart_id']?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
