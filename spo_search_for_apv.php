...
<?php
	...
	#$budget_source   		= $_REQUEST['budget_source'];
	...
	$budget_header_id_pad   =(!empty($budget_header_id))?str_pad($budget_header_id,7,"0",STR_PAD_LEFT):"";
...
<div class=form_layout>
    ...
    <div class="module_actions">
        ...
        <div class="inline" id="div_terms">
            Budget #:  <br />
			<input type="text" class="textbox3" name="budget_header_id_display" id="budget_name" value="<?=$budget_header_id_pad?>" readonly="readonly"  />
            <input type="text" class ="required" name="budget_header_id" id="budget_header_id" value="<?=$budget_header_id?>" title ="Please Fill Budget #" />
		...
		<div class="inline">
            Source of Fund : <br />
            <input type="text" class="textbox" name="budget_source" value="<?=$budget_source?>" />
        </div>
