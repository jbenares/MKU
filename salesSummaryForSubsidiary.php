...
<div class=form_layout>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="printSalesSummaryForSubsidiary.php?startdate=<?=$_REQUEST[startdate];?>&enddate=<?=$_REQUEST[enddate]?>&account_id=<?=$_REQUEST[account_id]?>" width="100%" height="500">
        </iframe>
    </div>
    <?php }?>
    </div>
