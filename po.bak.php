...
<?php
	...
	if($b=="Submit" && empty($po_header_id)){
...
<div class=form_layout>
            ...
            ?>
                <div id="accordion">
                    ...
                    *******************/
                    ...
                    if($rows > 0):
                    ?>
                    <h3><a href="#">SERVICE SEARCH RESULTS </a></h3>
                    <div>
                    <table cellspacing="2" cellpadding="5" width="100%" align="center" class="display_table" id="search_table">
                        <tr bgcolor="#C0C0C0">				
                            <th width="20">#</th>
                        ...
                        <tr>
                            <td><?=$i++?></td>
                            <td><input type="button" value="PO" onclick="xajax_service_po_stock_id_form('<?=$stock_id?>','<?=$quantity?>','<?=$days?>','<?=$rate_per_day?>','<?=$amount?>');" /></td>
                            <td><?=$stock?></td>
                    ...
                    *******************/
                    ...
                    <table cellspacing="2" cellpadding="5" width="100%" align="center" class="display_table" id="search_table">
                        <tr bgcolor="#C0C0C0">				
                            ...
                            <th width="100">PO Warehouse Quantity</th>
                            <th width="100">Balance</th>
                        </tr> 
                        <?php
                        $i=1;
                        while($r=mysql_fetch_assoc($result)){
                            $stock_id 		= $r['stock_id'];
                            $stock			= $r['stock'];
                            $pr_quantity	= $r['warehouse_quantity'];
                            $unit			= $r['unit'];
    ...
    <div>
		...
		*******************************/
        ...
        <div style="background-color::#FFF; font-weight:bolder; margin-top:10px;">PURCHASE ORDER SERVICE DETAILS  </div>
        <table cellspacing="2" cellpadding="5" width="100%" align="center" class="display_table" id="search_table" style="border: 1px solid #000;">
            <tr>
                <th width="20">#</th>
                <td width="20" align="center"></td>
