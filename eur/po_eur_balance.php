...
<div class=form_layout>
    ...
    <div class="module_actions">       
        ...
        <div style="display:inline-block;">
            PO Equipment<br />
            <input type="text" class="textbox equipment_name" name="po_equipment_name" value='<?=$_REQUEST['po_equipment_name']?>'  />
            <input type="hidden" name="po_equipment_id" value="<?=$_REQUEST['po_equipment_id']?>" >
        </div>
    ...
    <div style="padding:3px; text-align:center;" id="content">
     <?php
		...
		{
	?>
   		<iframe id="JOframe" name="JOframe" frameborder="0" src="eur/print_po_eur_balance.php?
            from_date=<?=$_REQUEST['from_date']?>&
            to_date=<?=$_REQUEST['to_date']?>&
            project_id=<?=$_REQUEST['project_id']?>&
            po_equipment_id=<?=($_REQUEST['po_equipment_name']) ? $_REQUEST['po_equipment_id'] : ""?>
...
<script type="text/javascript">
jQuery(".ac-po-equipment").autocomplete({
    source: "autocomplete/filename.php",
    minLength: 1,
