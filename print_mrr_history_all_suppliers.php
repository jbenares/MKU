...
<div class="container" style="width: 100%;">
     ...
     <div><!--Start of Form-->
        ...
        <div class="content" style="">
        	<?php
			if($supplier){
				$result = mysql_query("Select * from supplier where account like '%$supplier%' order by account asc") or die(mysql_error());
			}else{
				$result = mysql_query("Select * from supplier where account order by account asc") or die(mysql_error());
			}
			...
			foreach($suppliers as $supplier){
				$new_sup = mysql_real_escape_string($supplier);
            ?>        
            <?php
				$query="
					select
            ...
            ?>
                <table cellpadding="6" width="1200">
                	<caption style="text-align:left; font-weight:bold;"><?=$supplier?></caption>
                    <tr>
                        <th width="75">DATE</th>
                        ...
                        <th  width="75" style="text-align: right;">VAT</th>
