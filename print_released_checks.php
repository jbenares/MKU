...
<div class="container">
     ...
     <div><!--Start of Form-->
     	...
     	<div style="font-weight:bolder;">
        	...
        	BANK RECONCILATION - RELEASED CHECKS <br />
        ...
        <div class="content" style="">
        	<table cellpadding="6">
            	<tr>
                    ...
                    <th style="text-align:left;">DATE RELEASED</th>
             	...
             	<?php
					...
					if( !empty($_REQUEST['from_released_date']) && !empty($_REQUEST['to_released_date']) ){
						$query .= " and date_released between '$_REQUEST[from_released_date]' and '$_REQUEST[to_released_date]'";
					}
